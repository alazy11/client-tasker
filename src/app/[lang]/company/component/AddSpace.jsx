...
export default function AddSpace({ user, setGetSpace,setModel, getSpace,spaceHandler,spaceInfo,setReferesh,referesh}) {
 ...
 <svg width="1rem"
                  ...
                  <div className="p-4 border-t border-solid flex items-center justify-between " style={{backgroundColor:"var(--cu-background-main)",borderTopColor:"var(--cu-border-default)"}}>
                     <span>use kmkvf</span>
                     <button
               ...
               <div
                  className={` w-480px h-auto flex flex-col rounded-xl overflow-hidden relative z-2000  ${
